...
public class Location {
	...
	private int ID, stateNumber, countyNumeric;
	private String name, feature, state, county, map;
	private double latitude, longitude, elevation;
	
	public Location(String ID, String name, String feature, String state, String statenNumber, String county, String countyNumeric, String latitude, String longitude, String elevation, String map){
